...
from agent.tools.middleware import monitor_tool, log_before_model, retort_prompt_switch
...
class ReactAgent:
    def __init__(self):
        self.agent = create_agent(
            ...
            middleware = [monitor_tool, log_before_model, retort_prompt_switch],
        )
    ...
    def execute_stream(self, query: str):
        ...
        # context是上下文runtime中的信息，就是我们做提示词切换的标记
